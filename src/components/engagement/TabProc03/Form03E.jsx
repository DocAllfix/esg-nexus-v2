...
const STORAGE_KEY = "esg_form_03E";

const checklistG = [
  { cat: "G1 — Governance ESG e Struttura", items: [
    { q: "La governance ESG è integrata nella struttura del CdA (comitato ESG o simile)?", ref: "GRI 2-9 / ESRS G1-1", r: 3 },
    { q: "Il CdA approva formalmente le politiche e gli obiettivi ESG?", ref: "ESRS G1-1", r: 3 },
    { q: "Esistono indicatori ESG nei sistemi di incentivazione del management?", ref: "ESRS G1-1", r: 2 },
    { q: "I risk ESG sono integrati nel risk management aziendale?", ref: "ESRS 2-IRO / GRI 2-25", r: 2 },
  ]},
  { cat: "G1 — Etica, Anti-corruzione e Compliance", items: [
    { q: "Il codice etico è aggiornato (max 3 anni) e include anti-corruzione?", ref: "GRI 205-1 / ESRS G1-3", r: 2 },
    { q: "I dipendenti ricevono formazione documentata su anti-corruzione?", ref: "GRI 205-2", r: 3 },
    { q: "È attivo un canale di whistleblowing conforme D.Lgs. 24/2023?", ref: "GRI 2-26 / ESRS G1-3", r: 1 },
    { q: "Sono stati rilevati o segnalati episodi di corruzione nell'anno?", ref: "GRI 205-3", r: 5 },
    { q: "Esiste una policy per la gestione dei conflitti di interesse?", ref: "ESRS G1-3", r: 2 },
  ]},
  { cat: "G1 — Trasparenza e Rendicontazione", items: [
    { q: "L'azienda pubblica già un bilancio di sostenibilità o DNF?", ref: "GRI 2-3 / CSRD", r: 1 },
    { q: "I dati ESG sono sottoposti a verifica/assurance esterna?", ref: "GRI 2-5 / ESRS 1 §AR72", r: 1 },
    { q: "Esiste un processo di raccolta dati ESG strutturato e documentato?", ref: "ESRS 1", r: 2 },
  ]},
  { cat: "G2 — Lobbying e Relazioni Istituzionali", items: [
    { q: "Le posizioni di lobbying e le affiliazioni ad associazioni di categoria sono dichiarate?", ref: "GRI 415-1 / ESRS G1-4", r: 3 },
    { q: "Le donazioni politiche sono dichiarate o espressamente vietate?", ref: "GRI 415-1", r: 4 },
  ]},
];
...
export default function Form03E() {
  const [ratings, setRatings] = useState(
    checklistG.flatMap(cat => cat.items.map((item, i) => ({ key: `${cat.cat}-${i}`, val: item.r })))
  ...
  return (
    <FormWrapper
      ...
      meta={{ "Fase": "PROC-03.5", "Resp.": "Elena Mancini", "Standard": "GRI 2/205/415 + ESRS G1–G2" }}
      ruleBox="🏛️ Valutare la maturità della governance ESG. I gap su whistleblowing e bilancio di sostenibilità sono tipicamente critici per le aziende nella fase di prima rendicontazione."
      ruleBoxType="info"
